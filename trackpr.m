...
title('Logistic Fragility Function (x0 = 40, k = 0.22)')
grid on
hold on
xL = xlim;
yL = ylim;
p1 = [40, 0.5];
p2 = [50, 0.9];
plot([p1(1) p1(1)], [yL(1) p1(2)], '--r', 'LineWidth', 1)
plot([xL(1) p1(1)], [p1(2) p1(2)], '--r', 'LineWidth', 1)
plot([p2(1) p2(1)], [yL(1) p2(2)], '--r', 'LineWidth', 1)
plot([xL(1) p2(1)], [p2(2) p2(2)], '--r', 'LineWidth', 1)
hold off
